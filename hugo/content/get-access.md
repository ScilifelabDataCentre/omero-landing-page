...
- When the project ends the user is required to export their data and associated results from the SciLifeLab OMERO instance. 
...
### As SciLifeLab data producing infrastructure units (facility track)
